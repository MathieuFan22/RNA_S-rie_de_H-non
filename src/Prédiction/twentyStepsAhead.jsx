    ...
    const propagate20 = () => {
        ...
        for (let p = 0; p < numPrototypes; p++) {
            ...
            for (let step = 0; step < 20; step++) {
                ...
                if (step < 19) { // Update the inputs for the next step
            ...
            newPredictions.push(predictedValues[19]); // Push the twentieth step prediction
        }

        setPredictions20Step(newPredictions);
    };
